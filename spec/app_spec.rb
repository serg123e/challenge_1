...
RSpec.describe Challenge do
  describe '#evid' do
    ...
    it 'cleans up evid' do
      expect(@challenge.evid_cleanup('evid_966634dc-0bf6-1ff7-f4b6-08000c95c670')).to eq('966634dc-0bf6-1ff7-f4b6-08000c95c670')
    end
  ...
  describe '#Data processing' do
    ...
    it 'mapping fields well' do
      expect(@visits.first.keys).to include :evid, :pageviews, :vendor_site_id, :vendor_visit_id, :vendor_visitor_id, :visit_ip
